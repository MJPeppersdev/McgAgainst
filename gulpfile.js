...
gulp.task('watch', 'Compiles, then watcches client code, compiling on changes.', ['make:elm'], function() {
...
gulp.task('clean:elm', 'Delete compiled, generated & downloaded elm files.', function(cb) {
    return del([
        'elm-stuff/**',
        'public/javascripts/McgAgainst.js'
    ]);
});
