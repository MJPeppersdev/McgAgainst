module McgAgainst.Components.About exposing (show)
...
contents version =
    ([ p []
        [ text "McgAgainst is a web game based on the excellent "
     ...
     , p []
        [ text "McgAgainst is also inspired by: "
        , ul []
            [ li []
     ...
     , p []
        ...
        , a [ href "https://github.com/McGdevfunk824/McgAgainst", target "_blank", rel "noopener" ] [ text "GitHub repository" ]
