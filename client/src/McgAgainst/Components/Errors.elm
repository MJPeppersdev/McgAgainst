module McgAgainst.Components.Errors exposing (Message(..), Model, ApplicationInfo, view, update, init, reportUrl)
...
reportUrl applicationInfo message =
    ...
    in
        "https://github.com/McGdevfunk824/McgAgainst/issues/new?body=" ++ full
