module McgAgainst.Scenes.Config.UI exposing (view, deckIdInputLabel, passwordInputLabel, addDeckButton, setPasswordButton)
...
import McgAgainst.Scenes.Config.Messages exposing (Message(..), InputId(..), Deck(..))
          ...
          , tr []
                [ td [ colspan 4 ]
                    ...
                    , a
                        ...
                        , onClick (ConfigureDecks (Request "7PJ5E"))
                        ]
